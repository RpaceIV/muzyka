...
def main():
    ...
    pl_id = 'spotify:playlist:'+result['playlists']['items'][0]['id'] #'spotify:playlist:5RIbzhG2QqdkaP24iXLnZX'
    ...
    '''Track Name'''
    trackk = sp.track(response['items'][0]['track']['id'])
    print(trackk['name'])
    ...
    start = time.time()
    features = sp.audio_features(response['items'][0]['track']['id'])
